...
class PeopleRoutes {
    ...
    config() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.router.get('/:id', task_controller_1.default.getOneTask);
            this.router.post('/', task_controller_1.default.createTask);
            this.router.put('/:id', task_controller_1.default.updateTask);
            this.router.delete('/:id', task_controller_1.default.deleteTask);
        });
    }
}
